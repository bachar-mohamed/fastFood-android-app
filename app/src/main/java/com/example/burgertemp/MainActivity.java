...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryIds = new ArrayList(Arrays.asList(R.id.pizzaCat, R.id.burgerCat, R.id.tacosCat, R.id.saladCat));
    ...
    public void setProductsList(int id) {
        int index ;
        try {
            index = categoryIds.contains(id) ? categoryIds.indexOf(id)+1 : categoryIds.indexOf(id);
